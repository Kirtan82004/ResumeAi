        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/templates" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">Templates</a></li>
              <li><a href="/faq" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">FAQ</a></li>
            </ul>
          </div>
          <div>
